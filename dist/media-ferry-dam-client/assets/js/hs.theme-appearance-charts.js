...
// dark chart color
HSCore.components.HSChartJS.addTheme('need-attention', 'dark', {
  data: {
    datasets: [{
      backgroundColor: ['#F3ADAA', '#E0DBB7'],
      borderColor: '#1e2022',
      hoverBorderColor: '#1e2022'
    }]
  }
})

HSCore.components.HSChartJS.addTheme('DueSoon', 'dark', {
  data: {
    datasets: [{
      backgroundColor: ['#F3ADAA', '#78BAED', '#E0DBB7'],
      borderColor: '#1e2022',
      hoverBorderColor: '#1e2022'
    }]
  }
...
HSCore.components.HSChartJS.addTheme('ToDo', 'dark', {
  data: {
    datasets: [{
      backgroundColor: ['#F3ADAA', '#E0DBB7', '#D0A0F8'],
      borderColor: '#1e2022',
      hoverBorderColor: '#1e2022'
    }]
  }
...
HSCore.components.HSChartJS.addTheme('InProgress', 'dark', {
  data: {
    datasets: [{
      backgroundColor: ['#F3ADAA', '#E0DBB7', '#D0A0F8'],
      borderColor: '#1e2022',
